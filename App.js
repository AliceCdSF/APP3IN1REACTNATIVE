  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput
        ...
        value={idade}
      />
      <Button title="calcular" onPress={calcularIdade} color="#0000FF" /> 
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput
        ...
        placeholder="Altura"
      />
      <Button title="calcular" onPress={calcularAreaTriangulo} color="#0000FF" /> 
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput
        ...
        placeholder="Lado"
      />
      <Button title="calcular" onPress={calcularAreaQuadrado} color="#0000FF" /> 
      <Text style={styles.result}>área: {area}</Text>
    </View>
  );
}
